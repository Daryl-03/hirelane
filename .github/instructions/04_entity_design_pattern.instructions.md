...
# Instructions Copilot - Concrete & Fluent Entity Design (Next.js)
...
### Les Modèles (`src/modules/[concept]/domain/entities/`)
- Ne dépendent d'aucune librairie externe ni du framework web. **Interdiction formelle d'importer `next`, `react`, ou d'utiliser des hooks React dans une Entité.**
- Pas de génération d'UUID par une lib tierce directement dans l'entité sans passer par une interface/port. Uniquement du TypeScript pur et synchrone.
